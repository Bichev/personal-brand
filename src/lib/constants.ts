...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    date: '2026-02-22',
    readTime: '12 pieces',
    tags: ['Algorithmic Art', 'Generative', 'p5.js', 'Interactive'],
    published: true,
    source: 'internal',
    localPath: '/algoart/',
    featured: true,
  ...
  {
    id: 'soul-as-interface',
    title: 'Soul as Interface: Consciousness, Holographic Universe & the External Mind',
    excerpt: 'Are we agents plugged into a cosmic LLM? Exploring the hypothesis that the body is merely an interface, consciousness is externally generated, and the universe operates as a holographic computation system.',
    content: '',
    date: '2026-04-07',
    readTime: '18 min read',
    tags: ['Consciousness', 'Philosophy', 'Physics', 'Research'],
    published: true,
    source: 'internal',
    localPath: '/blog/soul-as-interface.html',
    featured: true,
  },
  {
    id: 'humans-vs-ai-agents',
    title: 'Humans vs AI Agents: A Comparative Research Framework',
    excerpt: 'A 14-dimension comparative framework examining humans, Hermes, OpenCLAW, and embodied robots across cognitive architecture, agency, inner life, and mortality — scoring what makes each form of intelligence unique.',
    content: '',
    date: '2026-04-07',
    readTime: '22 min read',
    tags: ['AI Agents', 'Consciousness', 'Comparative AI', 'Research'],
    published: true,
    source: 'internal',
    localPath: '/blog/humans-vs-ai-agents.html',
    featured: true,
  },
  {
